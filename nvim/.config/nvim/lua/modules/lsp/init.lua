...
local function lsp_keymaps(bufnr)
  ...
  buf_set_km(bufnr, "n", "gd", "<cmd>lua require('telescope.builtin').lsp_definitions()<CR>", opts)
  ...
  buf_set_km(bufnr, "n", "gr", "<cmd>lua require('telescope.builtin').lsp_references()<CR>", opts)
